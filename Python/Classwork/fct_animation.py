...
#
# Purpose:
#   To produce an animation of the wave solutions produced in fct_graph.
#
# Syntax:
#   python3 fct_animation.py solution_option
#
#   Input: None.
#
#   Output: An animation containing the comparisons between the exact
#           solution, the upstream scheme, the Lax-Wendroff scheme, and the
#           Zalesak algorithm flux-corrected transport approximations. 
#           Figures a and b are produced separately based on the command-line
#           argument.
#
...
while (current_time <= time_limit):
    ...
    im = plt.imshow((x_range, u_exact), animated=True)
    ims.append([im])

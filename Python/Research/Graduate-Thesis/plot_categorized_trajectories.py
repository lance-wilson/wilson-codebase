...
#
# Purpose:  Plot a specific group of categorized CM1 backward trajectories
...
#
# Execution Example:
#   python3 plot_categorized_trajectories.py v5 v5_meso_tornadogenesis forward_flank dbz x_stretch_term
#
...
if len(sys.argv) > mandatory_arg_num:
    ...
    print('Syntax: python3 plot_categorized_trajectories.py version_number parcel_label parcel_category field_variable budget_variable')
    print('Example: python3 plot_categorized_trajectories.py v5 v5_meso_tornadogenesis forward_flank dbz x_stretch_term')
...
if cat_traj_obj.existing_file:
    ...
    plot_indices = cat_traj_obj.meters_to_trajnum(traj_ds_obj.xpos, traj_ds_obj.ypos, traj_ds_obj.zpos)
else:
...
for budget_var_name in budget_var_names:
    ...
    for cur_file_num in plot_file_nums:
        # Inverted time index of the back trajectory data (which runs
        #   backwards in time).
